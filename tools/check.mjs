...
let bytes = 0;
for (const file of ['index.html', 'styles.css', 'script.js', 'favicon.svg']) bytes += (await stat(new URL(file, root))).size;
assert(bytes < 160 * 1024, 'El sitio supera el presupuesto de 160 KB sin compresión');
